            ...
            >
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2 items-stretch">
                  <select
                    className="text-base leading-[164%] font-normal text-jet-black px-5 py-3 rounded-full bg-soft-gray"
                    name=""
                    id=""
                    defaultValue="top"
                  >
                    <option value="top">Top kommentlar</option>
                  </select>
                  <button className="py-3 px-5  bg-jet-black rounded-full text-white leading-[164%] text-base font-normal">
                    Fikr qoldirish
                  </button>
                </div>
              </div>
